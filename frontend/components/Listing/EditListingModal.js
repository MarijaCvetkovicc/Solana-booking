...
export default function EditListingModal({ editListing, currentEditListing, editListingModalOpen, setEditListingModalOpen }) {
    ...
    const onEdit = (e) => {
        ...
        editListing({
            accommodationPda: currentEditListing.publicKey,
            accommodationIdx: currentEditListing?.account.idx,
            location,
            country,
            price,
            img:imageURL,
                                ...
                                <div className="mt-2">
                                    <div className="grid grid-cols-1 gap-3">
                                        ...
                                        <label className="flex flex-col border rounded-lg px-3 py-2" htmlFor="imageURL">
                                            ...
                                            <input placeholder={currentEditListing?.account.img} onChange={(e) => setImageURL(e.target.value)} className="outline-none bg-transparent text-sm pt-1" type="text" id="imageURL" name="imageURL" />
                                        </label>
                                    </div>
